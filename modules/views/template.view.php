...
<div id="main">
    ...
    <div id="header">
        <!-- LOGO WEBSITE -->
        <div id="logo">
            <font face="Courier New">www.bikin1bottom.com</font><br>
            <h1><font color="black"><strong>BIKIN1BOTTOM</strong></font><br></h1>
            <h2><font color="black"><strong>We Have Better Skills for Indonesia.</strong></font><br></h2>
        </div>

        <!-- SOCIAL MEDIA -->
        <div class="social">
            <ul>
                <li><a href="http://facebook.com/samuelpasarribu" target="_blank"><img src="resources/images/Facebook.png" alt="facebook"></a></li>
                <li><a href="http://github.com/Samuelpasaribu" target="_blank"><img src="resources/images/github.png" alt="github"></a></li>
                <li><a href="https://web.whatsapp.com/" target="_blank"><img src="resources/images/whatsapp.png" alt="whatsapp"></a></li>
                <li><a href="https://www.blogger.com/blogger.g?blogID=9213281573531910625#allposts" target="_blank"><img src="resources/images/blogger.png" alt="blogger"></a></li>
                <li><a href="https://www.jobstreet.co.id/" target="_blank"><img src="resources/images/jobstreet.png" alt="jobstreet"></a></li>
            </ul>
        </div>
    ...
    <div id="top-menu-website">
        ...
        <div class="middle-side">
            <ul>
                ...
                <li><a href="<?php echo SITE_URL; ?>?page=tentang" <?php if($page == "tentang") echo 'class="current"'; ?>>Tentang Website</a></li>
    ...
    <div id="footer">
        <div class="content-footer">
            ...
            <div class="middle-footer">
                &copy; Copyright BIKIN1BOTTOM All right reserved. Developer by <a href="http://facebook.com/samuelpasaribu95" target="_blank">samuel pasaribu</a>.
            </div>
